...
import com.example.rafif_atom.databinding.FragmentTabQrcodeBinding
...
class TabQrcodeFragment : Fragment() {
    ...
    private fun createQR(text: String): Bitmap {
        ...
        val matrix = writer.encode(text, BarcodeFormat.QR_CODE, 500, 500, mapOf(EncodeHintType.CHARACTER_SET to "UTF-8"))
